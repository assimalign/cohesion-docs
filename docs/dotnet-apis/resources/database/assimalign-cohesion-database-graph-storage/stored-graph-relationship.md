...
The `StoredGraphRelationship` type is part of the documented `Assimalign.Cohesion.Database.Graph.Storage` API.

> **Status:** Partial.

A durable directed relationship and its endpoints.
...
- **Source** — `cohesion/resources/Database/Assimalign.Cohesion.Database.Graph.Storage/src/StoredGraphNode.cs`.
