...
The `IGraphDatabase` type is part of the documented `Assimalign.Cohesion.Database.Graph` API.

> **Status:** Partial.

Represents a property-graph database: labeled nodes connected by typed, directed relationships, both
carrying properties.
...
- **Source** — `cohesion/resources/Database/Assimalign.Cohesion.Database.Graph/src/Abstractions/IGraphDatabase.cs`.
