# GraphPropertyKeyMetadata

The `GraphPropertyKeyMetadata` type is part of the documented `Assimalign.Cohesion.Database.Graph.Catalog` API.

> **Status:** Implemented.

A property key declared by a label or relationship type.
...
- **Source** — `cohesion/resources/Database/Assimalign.Cohesion.Database.Graph.Catalog/src/GraphPropertyKeyMetadata.cs`.
