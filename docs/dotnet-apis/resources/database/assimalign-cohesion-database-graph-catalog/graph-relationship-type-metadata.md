# GraphRelationshipTypeMetadata

The `GraphRelationshipTypeMetadata` type is part of the documented `Assimalign.Cohesion.Database.Graph.Catalog` API.

> **Status:** Implemented.

A relationship-type definition and the authority that owns it.
...
- **Source** — `cohesion/resources/Database/Assimalign.Cohesion.Database.Graph.Catalog/src/GraphRelationshipTypeMetadata.cs`.
