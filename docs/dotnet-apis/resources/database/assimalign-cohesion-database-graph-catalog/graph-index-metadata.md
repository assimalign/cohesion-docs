...
The `GraphIndexMetadata` type is part of the documented `Assimalign.Cohesion.Database.Graph.Catalog` API.

> **Status:** Implemented.

A named nonunique secondary node-property index definition.
...
- **Source** — `cohesion/resources/Database/Assimalign.Cohesion.Database.Graph.Catalog/src/GraphIndexMetadata.cs`.
