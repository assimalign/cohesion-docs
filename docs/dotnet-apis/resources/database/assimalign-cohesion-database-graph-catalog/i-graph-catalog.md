...
The `IGraphCatalog` type is part of the documented `Assimalign.Cohesion.Database.Graph.Catalog` API.

> **Status:** Implemented.

The durable, snapshot-visible definitions of one logical graph database.
...
- **Source** — `cohesion/resources/Database/Assimalign.Cohesion.Database.Graph.Catalog/src/Abstractions/IGraphCatalog.cs`.
