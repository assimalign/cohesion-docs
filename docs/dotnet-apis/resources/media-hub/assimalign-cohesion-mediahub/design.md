...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.MediaHub`.
...
`IMediaHubApplicationBuilder` is the contract-only builder seam, while `IMediaHubApplication`
...
The concrete application, builder, and context live in `Assimalign.Cohesion.MediaHub.Hosting`;
...
- **Primary source** — `cohesion/resources/MediaHub/Assimalign.Cohesion.MediaHub/docs/DESIGN.md`.
