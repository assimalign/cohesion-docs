...
The `MediaHubResource` type is part of the documented `Assimalign.Cohesion.MediaHub.ApplicationModel` API.

> **Status:** Partial.

Represents a manifest-backed MediaHub workload in an application graph.
...
- **Source** — `cohesion/resources/MediaHub/Assimalign.Cohesion.MediaHub.ApplicationModel/src/MediaHubResource.cs`.
