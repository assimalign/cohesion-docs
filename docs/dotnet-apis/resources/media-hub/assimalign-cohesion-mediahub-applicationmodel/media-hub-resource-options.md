# MediaHubResourceOptions

The `MediaHubResourceOptions` type is part of the documented `Assimalign.Cohesion.MediaHub.ApplicationModel` API.

> **Status:** Partial.

Provides deployer-owned planning overrides for a MediaHub resource.
...
- **Source** — `cohesion/resources/MediaHub/Assimalign.Cohesion.MediaHub.ApplicationModel/src/MediaHubResourceOptions.cs`.
