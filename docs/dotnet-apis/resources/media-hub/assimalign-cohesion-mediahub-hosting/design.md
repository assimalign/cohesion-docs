...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.MediaHub.Hosting`.
...
`ContentIoService` and `StreamingEndpointService` remain as dormant future service stubs and are not
...
- **Primary source** — `cohesion/resources/MediaHub/Assimalign.Cohesion.MediaHub.Hosting/docs/DESIGN.md`.
