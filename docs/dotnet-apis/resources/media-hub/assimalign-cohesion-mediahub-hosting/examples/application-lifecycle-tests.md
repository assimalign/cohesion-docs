...
This example exercises `Assimalign.Cohesion.MediaHub.Hosting` through its co-located test source.

> **Status:** Partial.

The example reproduces
`cohesion/resources/MediaHub/Assimalign.Cohesion.MediaHub.Hosting/tests/ApplicationLifecycleTests.cs`
...
- **Primary source** — `cohesion/resources/MediaHub/Assimalign.Cohesion.MediaHub.Hosting/tests/ApplicationLifecycleTests.cs`.
- **Source** — `cohesion/resources/MediaHub/Assimalign.Cohesion.MediaHub.Hosting/tests/Assimalign.Cohesion.MediaHub.Hosting.Tests.csproj`.
