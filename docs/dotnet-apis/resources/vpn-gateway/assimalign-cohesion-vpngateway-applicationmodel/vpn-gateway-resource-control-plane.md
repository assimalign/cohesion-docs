# VpnGatewayResourceControlPlane

The `VpnGatewayResourceControlPlane` type is part of the documented `Assimalign.Cohesion.VpnGateway.ApplicationModel` API.

> **Status:** Partial.

Creates the default control plane for enabled VpnGateway resources.
...
- **Source** — `cohesion/resources/VpnGateway/Assimalign.Cohesion.VpnGateway.ApplicationModel/src/VpnGatewayResourceControlPlane.cs`.
