...
The `VpnGatewayResource` type is part of the documented `Assimalign.Cohesion.VpnGateway.ApplicationModel` API.

> **Status:** Partial.

Represents a manifest-backed VpnGateway workload in an application graph.
...
- **Source** — `cohesion/resources/VpnGateway/Assimalign.Cohesion.VpnGateway.ApplicationModel/src/VpnGatewayResource.cs`.
