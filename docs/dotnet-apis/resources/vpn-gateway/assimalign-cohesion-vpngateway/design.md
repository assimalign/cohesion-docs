...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.VpnGateway`.
...
`IVpnGatewayApplicationBuilder` is the contract-only builder seam, while `IVpnGatewayApplication`
...
The concrete application, builder, and context live in `Assimalign.Cohesion.VpnGateway.Hosting`;
...
- **Primary source** — `cohesion/resources/VpnGateway/Assimalign.Cohesion.VpnGateway/docs/DESIGN.md`.
