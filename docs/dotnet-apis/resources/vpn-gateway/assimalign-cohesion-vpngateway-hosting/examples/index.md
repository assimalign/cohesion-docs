...
Examples for `Assimalign.Cohesion.VpnGateway.Hosting` are derived from source documentation and code.
...
- **[Application Lifecycle Tests](application-lifecycle-tests.md)** — This example exercises `Assimalign.Cohesion.VpnGateway.Hosting` through its co-located test source.
