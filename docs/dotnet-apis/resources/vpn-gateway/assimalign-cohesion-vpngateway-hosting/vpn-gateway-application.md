...
The `VpnGatewayApplication` type belongs to `Assimalign.Cohesion.VpnGateway.Hosting`.

> **Status:** Partial.

Namespace: `Assimalign.Cohesion.VpnGateway.Hosting` Assembly:
`Assimalign.Cohesion.VpnGateway.Hosting`

## Purpose

`VpnGatewayApplication` is the public concrete application and creation entry point for the VPN
...
- **Primary source** — `cohesion/resources/VpnGateway/Assimalign.Cohesion.VpnGateway.Hosting/docs/Assembly/Assimalign.Cohesion.VpnGateway.Hosting/VpnGatewayApplication/OVERVIEW.md`.
