...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.ApiManager`.
...
`IApiManagerApplicationBuilder` is the contract-only builder seam, while `IApiManagerApplication`
...
The concrete application, builder, and context live in `Assimalign.Cohesion.ApiManager.Hosting`;
...
- **Primary source** — `cohesion/resources/ApiManager/Assimalign.Cohesion.ApiManager/docs/DESIGN.md`.
