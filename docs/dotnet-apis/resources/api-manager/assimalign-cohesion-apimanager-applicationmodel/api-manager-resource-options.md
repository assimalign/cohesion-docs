# ApiManagerResourceOptions

The `ApiManagerResourceOptions` type is part of the documented `Assimalign.Cohesion.ApiManager.ApplicationModel` API.

> **Status:** Partial.

Provides deployer-owned planning overrides for a ApiManager resource.
...
- **Source** — `cohesion/resources/ApiManager/Assimalign.Cohesion.ApiManager.ApplicationModel/src/ApiManagerResourceOptions.cs`.
