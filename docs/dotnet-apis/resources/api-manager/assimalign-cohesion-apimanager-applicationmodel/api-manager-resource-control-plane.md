# ApiManagerResourceControlPlane

The `ApiManagerResourceControlPlane` type is part of the documented `Assimalign.Cohesion.ApiManager.ApplicationModel` API.

> **Status:** Partial.

Creates the default control plane for enabled ApiManager resources.
...
- **Source** — `cohesion/resources/ApiManager/Assimalign.Cohesion.ApiManager.ApplicationModel/src/ApiManagerResourceControlPlane.cs`.
