...
The `ApiManagerApplication` type belongs to `Assimalign.Cohesion.ApiManager.Hosting`.

> **Status:** Partial.

Namespace: `Assimalign.Cohesion.ApiManager.Hosting` Assembly:
`Assimalign.Cohesion.ApiManager.Hosting`

## Purpose

`ApiManagerApplication` is the public concrete application and creation entry point for the API
manager hosting module. The application, builder, and context are public; runtime options remain
internal.
...
- **Primary source** — `cohesion/resources/ApiManager/Assimalign.Cohesion.ApiManager.Hosting/docs/Assembly/Assimalign.Cohesion.ApiManager.Hosting/ApiManagerApplication/OVERVIEW.md`.
