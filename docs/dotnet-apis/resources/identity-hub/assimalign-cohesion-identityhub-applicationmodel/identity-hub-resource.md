...
The `IdentityHubResource` type is part of the documented `Assimalign.Cohesion.IdentityHub.ApplicationModel` API.
...
- **Source** — `cohesion/resources/IdentityHub/Assimalign.Cohesion.IdentityHub.ApplicationModel/src/IdentityHubResource.cs`.
