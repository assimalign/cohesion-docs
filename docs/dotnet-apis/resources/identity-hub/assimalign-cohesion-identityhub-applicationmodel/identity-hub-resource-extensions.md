# IdentityHubResourceExtensions

The `IdentityHubResourceExtensions` type is part of the documented `Assimalign.Cohesion.IdentityHub.ApplicationModel` API.
...
- **Source** — `cohesion/resources/IdentityHub/Assimalign.Cohesion.IdentityHub.ApplicationModel/src/Extensions/IdentityHubResourceExtensions.cs`.
