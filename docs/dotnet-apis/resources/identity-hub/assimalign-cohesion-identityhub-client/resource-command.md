...
The `ResourceCommand` type belongs to `Assimalign.Cohesion.IdentityHub.Client`.
...
- **Primary source** — `cohesion/resources/IdentityHub/Assimalign.Cohesion.IdentityHub.Client/docs/Assembly/Assimalign.Cohesion.IdentityHub.Client/ResourceCommand/OVERVIEW.md`.
