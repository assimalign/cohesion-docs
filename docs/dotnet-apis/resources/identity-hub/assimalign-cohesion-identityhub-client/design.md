...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.IdentityHub.Client`.
...
- **Primary source** — `cohesion/resources/IdentityHub/Assimalign.Cohesion.IdentityHub.Client/docs/DESIGN.md`.
