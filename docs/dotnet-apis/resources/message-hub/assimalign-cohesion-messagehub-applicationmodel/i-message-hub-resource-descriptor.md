# IMessageHubResourceDescriptor

The `IMessageHubResourceDescriptor` type is part of the documented `Assimalign.Cohesion.MessageHub.ApplicationModel` API.
...
- **Source** — `cohesion/resources/MessageHub/Assimalign.Cohesion.MessageHub.ApplicationModel/src/Abstractions/IMessageHubResourceDescriptor.cs`.
