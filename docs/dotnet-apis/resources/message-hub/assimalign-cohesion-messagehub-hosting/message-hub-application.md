...
The `MessageHubApplication` type belongs to `Assimalign.Cohesion.MessageHub.Hosting`.

> **Status:** Partial.

Namespace: `Assimalign.Cohesion.MessageHub.Hosting` Assembly:
`Assimalign.Cohesion.MessageHub.Hosting`

## Purpose

`MessageHubApplication` is the public concrete application and creation entry point for the
MessageHub hosting module. The application, builder, and context are public; runtime options remain
internal.
...
- **Primary source** — `cohesion/resources/MessageHub/Assimalign.Cohesion.MessageHub.Hosting/docs/Assembly/Assimalign.Cohesion.MessageHub.Hosting/MessageHubApplication/OVERVIEW.md`.
