...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.MessageHub.Hosting`.
...
`JournalFlushService` and `BrokerEndpointService` remain as dormant future service stubs and are not
...
- **Primary source** — `cohesion/resources/MessageHub/Assimalign.Cohesion.MessageHub.Hosting/docs/DESIGN.md`.
