...
Examples for `Assimalign.Cohesion.MessageHub.Hosting` are derived from source documentation and code.
...
- **[Application Lifecycle Tests](application-lifecycle-tests.md)** — This example exercises `Assimalign.Cohesion.MessageHub.Hosting` through its co-located test source.
