...
The `LogSpaceApplication` type belongs to `Assimalign.Cohesion.LogSpace.Hosting`.

> **Status:** Partial.

Namespace: `Assimalign.Cohesion.LogSpace.Hosting` Assembly: `Assimalign.Cohesion.LogSpace.Hosting`

## Purpose

`LogSpaceApplication` is the public concrete application and creation entry point for the LogSpace
...
- **Primary source** — `cohesion/resources/LogSpace/Assimalign.Cohesion.LogSpace.Hosting/docs/Assembly/Assimalign.Cohesion.LogSpace.Hosting/LogSpaceApplication/OVERVIEW.md`.
