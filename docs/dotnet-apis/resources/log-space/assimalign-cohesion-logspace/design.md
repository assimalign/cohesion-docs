...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.LogSpace`.
...
`ILogSpaceApplicationBuilder` is the contract-only builder seam, while `ILogSpaceApplication`
...
The concrete application, builder, and context live in `Assimalign.Cohesion.LogSpace.Hosting`;
...
- **Primary source** — `cohesion/resources/LogSpace/Assimalign.Cohesion.LogSpace/docs/DESIGN.md`.
