...
The `EmailHubApplication` type belongs to `Assimalign.Cohesion.EmailHub.Hosting`.

> **Status:** Partial.

Namespace: `Assimalign.Cohesion.EmailHub.Hosting` Assembly: `Assimalign.Cohesion.EmailHub.Hosting`

## Purpose

`EmailHubApplication` is the public concrete application and creation entry point for the email hub
...
- **Primary source** — `cohesion/resources/EmailHub/Assimalign.Cohesion.EmailHub.Hosting/docs/Assembly/Assimalign.Cohesion.EmailHub.Hosting/EmailHubApplication/OVERVIEW.md`.
