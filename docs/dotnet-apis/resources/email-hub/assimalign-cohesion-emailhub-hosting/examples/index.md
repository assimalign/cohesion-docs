...
Examples for `Assimalign.Cohesion.EmailHub.Hosting` are derived from source documentation and code.
...
- **[Application Lifecycle Tests](application-lifecycle-tests.md)** — This example exercises `Assimalign.Cohesion.EmailHub.Hosting` through its co-located test source.
