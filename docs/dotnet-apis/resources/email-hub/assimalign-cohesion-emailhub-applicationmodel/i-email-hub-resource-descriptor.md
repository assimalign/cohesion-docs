# IEmailHubResourceDescriptor

The `IEmailHubResourceDescriptor` type is part of the documented `Assimalign.Cohesion.EmailHub.ApplicationModel` API.
...
- **Source** — `cohesion/resources/EmailHub/Assimalign.Cohesion.EmailHub.ApplicationModel/src/Abstractions/IEmailHubResourceDescriptor.cs`.
