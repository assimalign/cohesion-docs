# Email Hub Resource Tests

This example exercises `Assimalign.Cohesion.EmailHub.ApplicationModel` through its co-located test source.

> **Status:** Partial.

The example reproduces
`cohesion/resources/EmailHub/Assimalign.Cohesion.EmailHub.ApplicationModel/tests/EmailHubResourceTests.cs`
...
- **Case 2** — `AddEmailHub`: returns typed graph descriptor.
...
- **Primary source** — `cohesion/resources/EmailHub/Assimalign.Cohesion.EmailHub.ApplicationModel/tests/EmailHubResourceTests.cs`.
- **Source** — `cohesion/resources/EmailHub/Assimalign.Cohesion.EmailHub.ApplicationModel/tests/Assimalign.Cohesion.EmailHub.ApplicationModel.Tests.csproj`.
