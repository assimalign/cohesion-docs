...
The `EmailHubResource` type is part of the documented `Assimalign.Cohesion.EmailHub.ApplicationModel` API.

> **Status:** Partial.

Represents a manifest-backed EmailHub workload in an application graph.
...
- **Source** — `cohesion/resources/EmailHub/Assimalign.Cohesion.EmailHub.ApplicationModel/src/EmailHubResource.cs`.
