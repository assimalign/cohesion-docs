# EmailHubResourceControlPlane

The `EmailHubResourceControlPlane` type is part of the documented `Assimalign.Cohesion.EmailHub.ApplicationModel` API.

> **Status:** Partial.

Creates the default control plane for enabled EmailHub resources.
...
- **Source** — `cohesion/resources/EmailHub/Assimalign.Cohesion.EmailHub.ApplicationModel/src/EmailHubResourceControlPlane.cs`.
