...
This example exercises `Assimalign.Cohesion.NatGateway.Hosting` through its co-located test source.

> **Status:** Partial.

The example reproduces
`cohesion/resources/NatGateway/Assimalign.Cohesion.NatGateway.Hosting/tests/ApplicationLifecycleTests.cs`
...
- **Primary source** — `cohesion/resources/NatGateway/Assimalign.Cohesion.NatGateway.Hosting/tests/ApplicationLifecycleTests.cs`.
- **Source** — `cohesion/resources/NatGateway/Assimalign.Cohesion.NatGateway.Hosting/tests/Assimalign.Cohesion.NatGateway.Hosting.Tests.csproj`.
