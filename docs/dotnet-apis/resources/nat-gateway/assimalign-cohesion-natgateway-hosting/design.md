...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.NatGateway.Hosting`.
...
`TranslationDataPlaneService` remains as a dormant future service stub and is not registered by
default.
...
- **Primary source** — `cohesion/resources/NatGateway/Assimalign.Cohesion.NatGateway.Hosting/docs/DESIGN.md`.
