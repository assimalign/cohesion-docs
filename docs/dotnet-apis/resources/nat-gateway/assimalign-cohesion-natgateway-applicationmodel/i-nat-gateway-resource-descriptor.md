# INatGatewayResourceDescriptor

The `INatGatewayResourceDescriptor` type is part of the documented `Assimalign.Cohesion.NatGateway.ApplicationModel` API.
...
- **Source** — `cohesion/resources/NatGateway/Assimalign.Cohesion.NatGateway.ApplicationModel/src/Abstractions/INatGatewayResourceDescriptor.cs`.
