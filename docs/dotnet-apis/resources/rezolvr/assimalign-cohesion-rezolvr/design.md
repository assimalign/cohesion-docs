...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.Rezolvr`.
...
`IRezolvrApplicationBuilder` is the contract-only builder seam, while `IRezolvrApplication` supplies
...
The concrete application, builder, and context live in `Assimalign.Cohesion.Rezolvr.Hosting`;
...
- **Primary source** — `cohesion/resources/Rezolvr/Assimalign.Cohesion.Rezolvr/docs/DESIGN.md`.
