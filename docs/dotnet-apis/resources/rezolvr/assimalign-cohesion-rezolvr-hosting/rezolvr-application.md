...
The `RezolvrApplication` type belongs to `Assimalign.Cohesion.Rezolvr.Hosting`.

> **Status:** Partial.

Namespace: `Assimalign.Cohesion.Rezolvr.Hosting` Assembly: `Assimalign.Cohesion.Rezolvr.Hosting`

## Purpose

`RezolvrApplication` is the public concrete application and creation entry point for the Rezolvr
...
- **Primary source** — `cohesion/resources/Rezolvr/Assimalign.Cohesion.Rezolvr.Hosting/docs/Assembly/Assimalign.Cohesion.Rezolvr.Hosting/RezolvrApplication/OVERVIEW.md`.
