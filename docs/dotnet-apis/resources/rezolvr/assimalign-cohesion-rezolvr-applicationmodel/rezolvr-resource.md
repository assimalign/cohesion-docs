...
The `RezolvrResource` type is part of the documented `Assimalign.Cohesion.Rezolvr.ApplicationModel` API.

> **Status:** Partial.

Represents a manifest-backed Rezolvr workload in an application graph.
...
- **Source** — `cohesion/resources/Rezolvr/Assimalign.Cohesion.Rezolvr.ApplicationModel/src/RezolvrResource.cs`.
