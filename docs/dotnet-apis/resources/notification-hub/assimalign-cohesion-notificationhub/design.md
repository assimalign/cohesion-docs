...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.NotificationHub`.
...
`INotificationHubApplicationBuilder` is the contract-only builder seam, while
`INotificationHubApplication` supplies the hosting-free application lifecycle.
...
The concrete application, builder, and context live in `Assimalign.Cohesion.NotificationHub.Hosting`
...
- **Primary source** — `cohesion/resources/NotificationHub/Assimalign.Cohesion.NotificationHub/docs/DESIGN.md`.
