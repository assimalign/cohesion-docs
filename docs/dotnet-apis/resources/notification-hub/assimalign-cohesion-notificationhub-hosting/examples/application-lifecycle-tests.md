...
This example exercises `Assimalign.Cohesion.NotificationHub.Hosting` through its co-located test source.

> **Status:** Partial.

The example reproduces
`cohesion/resources/NotificationHub/Assimalign.Cohesion.NotificationHub.Hosting/tests/ApplicationLifecycleTests.cs`
...
- **Primary source** — `cohesion/resources/NotificationHub/Assimalign.Cohesion.NotificationHub.Hosting/tests/ApplicationLifecycleTests.cs`.
- **Source** — `cohesion/resources/NotificationHub/Assimalign.Cohesion.NotificationHub.Hosting/tests/Assimalign.Cohesion.NotificationHub.Hosting.Tests.csproj`.
