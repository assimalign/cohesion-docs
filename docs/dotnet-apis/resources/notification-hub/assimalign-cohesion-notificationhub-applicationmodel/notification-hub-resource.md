...
The `NotificationHubResource` type is part of the documented `Assimalign.Cohesion.NotificationHub.ApplicationModel` API.

> **Status:** Partial.

Represents a manifest-backed NotificationHub workload in an application graph.
...
- **Source** — `cohesion/resources/NotificationHub/Assimalign.Cohesion.NotificationHub.ApplicationModel/src/NotificationHubResource.cs`.
