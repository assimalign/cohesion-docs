# NotificationHubResourceControlPlane

The `NotificationHubResourceControlPlane` type is part of the documented `Assimalign.Cohesion.NotificationHub.ApplicationModel` API.

> **Status:** Partial.

Creates the default control plane for enabled NotificationHub resources.
...
- **Source** — `cohesion/resources/NotificationHub/Assimalign.Cohesion.NotificationHub.ApplicationModel/src/NotificationHubResourceControlPlane.cs`.
