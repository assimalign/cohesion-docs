...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.EventHub`.
...
`IEventHubApplicationBuilder` is the contract-only builder seam, while `IEventHubApplication`
...
The concrete application, builder, and context live in `Assimalign.Cohesion.EventHub.Hosting`;
...
- **Primary source** — `cohesion/resources/EventHub/Assimalign.Cohesion.EventHub/docs/DESIGN.md`.
