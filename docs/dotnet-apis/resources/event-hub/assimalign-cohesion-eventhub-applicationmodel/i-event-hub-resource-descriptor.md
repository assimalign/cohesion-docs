# IEventHubResourceDescriptor

The `IEventHubResourceDescriptor` type is part of the documented `Assimalign.Cohesion.EventHub.ApplicationModel` API.
...
- **Source** — `cohesion/resources/EventHub/Assimalign.Cohesion.EventHub.ApplicationModel/src/Abstractions/IEventHubResourceDescriptor.cs`.
