...
The `EventHubResource` type is part of the documented `Assimalign.Cohesion.EventHub.ApplicationModel` API.

> **Status:** Partial.

Represents a manifest-backed EventHub workload in an application graph.
...
- **Source** — `cohesion/resources/EventHub/Assimalign.Cohesion.EventHub.ApplicationModel/src/EventHubResource.cs`.
