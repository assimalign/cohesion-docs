# EventHubResourceControlPlane

The `EventHubResourceControlPlane` type is part of the documented `Assimalign.Cohesion.EventHub.ApplicationModel` API.

> **Status:** Partial.

Creates the default control plane for enabled EventHub resources.
...
- **Source** — `cohesion/resources/EventHub/Assimalign.Cohesion.EventHub.ApplicationModel/src/EventHubResourceControlPlane.cs`.
