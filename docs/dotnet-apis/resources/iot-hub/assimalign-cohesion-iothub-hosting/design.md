...
This page describes the boundaries and implementation shape of `Assimalign.Cohesion.IoTHub.Hosting`.
...
shared host lifecycle without claiming that IoT-hub behavior exists.

`TelemetryJournalService` and `DeviceIngressService` remain as dormant future service stubs. The
filler builder does not register them automatically.
...
| Reference | Kind |
|---|---|
| `Assimalign.Cohesion.IoTHub` | `CohesionProjectReference` |
...
- **Primary source** — `cohesion/resources/IoTHub/Assimalign.Cohesion.IoTHub.Hosting/docs/DESIGN.md`.
- **Source** — `cohesion/resources/IoTHub/Assimalign.Cohesion.IoTHub.Hosting/src/Assimalign.Cohesion.IoTHub.Hosting.csproj`.
