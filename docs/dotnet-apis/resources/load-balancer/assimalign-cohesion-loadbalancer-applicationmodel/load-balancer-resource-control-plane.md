# LoadBalancerResourceControlPlane

The `LoadBalancerResourceControlPlane` type is part of the documented `Assimalign.Cohesion.LoadBalancer.ApplicationModel` API.

> **Status:** Partial.

Creates the default control plane for enabled LoadBalancer resources.
...
- **Source** — `cohesion/resources/LoadBalancer/Assimalign.Cohesion.LoadBalancer.ApplicationModel/src/LoadBalancerResourceControlPlane.cs`.
