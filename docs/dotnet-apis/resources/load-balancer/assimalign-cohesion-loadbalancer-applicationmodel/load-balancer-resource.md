...
The `LoadBalancerResource` type is part of the documented `Assimalign.Cohesion.LoadBalancer.ApplicationModel` API.

> **Status:** Partial.

Represents a manifest-backed LoadBalancer workload in an application graph.
...
- **Source** — `cohesion/resources/LoadBalancer/Assimalign.Cohesion.LoadBalancer.ApplicationModel/src/LoadBalancerResource.cs`.
