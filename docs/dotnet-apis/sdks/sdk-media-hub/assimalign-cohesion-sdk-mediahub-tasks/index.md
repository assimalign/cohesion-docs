# Assimalign.Cohesion.Sdk.MediaHub.Tasks

This build-time assembly project packages the MediaHub SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.MediaHub`. Its output directory is
