# Assimalign.Cohesion.Sdk.IdentityHub.Tasks

This build-time assembly project packages the IdentityHub SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.IdentityHub`. Its output directory is
