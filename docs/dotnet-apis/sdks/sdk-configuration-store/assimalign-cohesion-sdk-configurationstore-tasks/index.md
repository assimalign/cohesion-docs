# Assimalign.Cohesion.Sdk.ConfigurationStore.Tasks

This build-time assembly project packages the ConfigurationStore SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.ConfigurationStore`. Its output directory is
