# Assimalign.Cohesion.Sdk.EmailHub.Tasks

This build-time assembly project packages the EmailHub SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.EmailHub`. Its output directory is
