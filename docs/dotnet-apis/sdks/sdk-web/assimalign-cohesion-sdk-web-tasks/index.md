# Assimalign.Cohesion.Sdk.Web.Tasks

This build-time assembly project packages the Web SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.Web`. Its output directory is
