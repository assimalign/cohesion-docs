# Assimalign.Cohesion.Sdk.ApiManager.Tasks

This build-time assembly project packages the ApiManager SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.ApiManager`. Its output directory is
