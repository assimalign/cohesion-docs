...
The ApiManager task project is a packaging shell around the common SDK build pipeline.
...
task API. After substituting area names, this props file is byte-identical to the `EmailHub`,
`EventHub`, `IoTHub`, `MediaHub`, `MessageHub`, `NotificationHub` props files.
