...
The LoadBalancer task project is a packaging shell around the common SDK build pipeline.
...
task API. After substituting area names, this props file is byte-identical to the `NatGateway`,
