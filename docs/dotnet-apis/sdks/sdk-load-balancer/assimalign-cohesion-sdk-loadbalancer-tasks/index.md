# Assimalign.Cohesion.Sdk.LoadBalancer.Tasks

This build-time assembly project packages the LoadBalancer SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.LoadBalancer`. Its output directory is
