# Assimalign.Cohesion.Sdk.EventHub.Tasks

This build-time assembly project packages the EventHub SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.EventHub`. Its output directory is
