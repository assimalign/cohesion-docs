# Assimalign.Cohesion.Sdk.LogSpace.Tasks

This build-time assembly project packages the LogSpace SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.LogSpace`. Its output directory is
