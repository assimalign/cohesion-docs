# Assimalign.Cohesion.Sdk.NatGateway.Tasks

This build-time assembly project packages the NatGateway SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.NatGateway`. Its output directory is
