# Assimalign.Cohesion.Sdk.NotificationHub.Tasks

This build-time assembly project packages the NotificationHub SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.NotificationHub`. Its output directory is
