# Assimalign.Cohesion.Sdk.Scheduler.Tasks

This build-time assembly project packages the Scheduler SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.Scheduler`. Its output directory is
