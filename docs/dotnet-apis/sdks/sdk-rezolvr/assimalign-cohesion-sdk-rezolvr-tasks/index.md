# Assimalign.Cohesion.Sdk.Rezolvr.Tasks

This build-time assembly project packages the Rezolvr SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.Rezolvr`. Its output directory is
