# Assimalign.Cohesion.Sdk.VpnGateway.Tasks

This build-time assembly project packages the VpnGateway SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.VpnGateway`. Its output directory is
