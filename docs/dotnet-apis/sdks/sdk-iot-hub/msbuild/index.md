...
The IoTHub SDK surrounds the consumer project with base imports and area defaults.

## Evaluation order

1. `Assimalign.Cohesion.Sdk.IoTHub/Sdk/Sdk.props` begins.
...
10. `Assimalign.Cohesion.Sdk.IoTHub/Sdk/Sdk.props` adds the area framework reference, then imports
...
`Targets/Sdk.IoTHub.targets` is an empty file and is not imported by `Sdk/Sdk.targets`. Evaluation
