# Assimalign.Cohesion.Sdk.IoTHub.Tasks

This build-time assembly project packages the IoTHub SDK imports and targets.

The project’s `PackageId` is `Assimalign.Cohesion.Sdk.IoTHub`. Its output directory is
